...
river<-read.table("C:/Users/aecsk/Desktop/river_taxa.txt",header=TRUE)
riversites<-read.table("C:/Users/aecsk/Desktop/river_sites.txt",header=TRUE)
...
adonis(formula=river~riversites$Month*riversites$Enviro)



#moving plot to ggplot

data.scores <- as.data.frame(scores(rivernmds))
...
hull.sample<-c("A","A","A","A","A","B","B","B","B","C","C","C","C","D","D","D","D","D","E","E","E","E","E","E","F","F","F","F","G","G","G","G","G","H","H","H","H","I","I","I","I","I","I","J","J","J","J") #add column for groups (these are based on this data only)
...
colnames(riverdiv)<-c("Simpsons","Enviro","Month","Site","Replicate") #rename columns
